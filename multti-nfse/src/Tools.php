...
use Multti\MulttiNFse\Common\Tools as BaseTools;
...
class Tools extends BaseTools
{
    ...
    public function consultarNota($dtInicial, $dtFinal, $id): string
    {
        ...
        '</Prestador>' .
        '<PeriodoEmissao>' .
            '<DataInicial>2009-09-28</DataInicial>' .
            '<DataFinal>2009-09-28</DataFinal>' .
        '</PeriodoEmissao>' .
        '<Tomador>' .
            '<CpfCnpj>' .
                '<Cnpj>99999999000191</Cnpj>' .
    ...
    '</ConsultarNfseEnvio>';
        ...
        //}
        //Validator::isValid($content, public_path('nfse v2 0.xsd'));
        return $this->send($content, $operation);
    }
